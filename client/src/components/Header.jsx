      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 w-full">
        <div className="flex items-center justify-between min-w-0 gap-2">
          ...
          <a href="/" className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
            <img src="/logo_bg_removed.png" alt="SwipeIT" className="w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20 object-contain" />
              ...
              {userType === 'guest' && (
                <div className="flex items-center justify-center p-5 border-b border-gray-200">
                  <div className="flex items-center gap-3">
                    <img src="/logo_bg_removed.png" alt="SwipeIT" className="w-16 h-16 object-contain" />
