              ...
              <div className="mb-3">
                ...
                <div className="flex items-center">
                  {recruiterAttitude === undefined ? (
                    <div className="mt-4"><LoadingSpinner size="sm" text="Loading recruiter profile..." /></div>
                  ) : recruiterAttitude ? (
              ...
              <div className="w-2/3 p-6 overflow-auto min-h-0" style={{ maxHeight: 'calc(80vh - 96px)' }}>
                <div className="flex items-start justify-between mb-4">
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-2">
                      <span className={`px-3 py-1 rounded-full text-sm font-medium ${job.status === 'applied' ? 'bg-blue-100 text-blue-800' :
                ...
                <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="p-4 rounded" style={{ backgroundColor: 'var(--card)', border: '1px solid var(--border)' }}>
                    ...
                    <div className="mt-3">
                      {recruiterAttitude === undefined ? (
                        <div className="mt-2"><LoadingSpinner size="sm" text="Loading recruiter profile..." /></div>
                      ) : recruiterAttitude ? (
    ...
    <div className="p-3 sm:p-4 max-w-full overflow-x-hidden">
      ...
      <div className="flex items-center gap-2 mb-4 flex-wrap">
        ...
        <button
          ...
          className={`px-3 py-2 rounded-lg text-sm font-medium transition-colors ${statusFilter === 'applied'
        ...
        <button
          ...
          className={`px-3 py-2 rounded-lg text-sm font-medium transition-colors ${statusFilter === 'shortlisted'
        ...
        <button
          ...
          className={`px-3 py-2 rounded-lg text-sm font-medium transition-colors ${statusFilter === 'rejected'
          ...
          {filteredJobs.map(job => (
            ...
            >
              ...
              <div className="flex items-start justify-between mb-2">
                ...
                <span className={`px-2 py-0.5 rounded-full text-xs font-medium whitespace-nowrap ml-2 flex-shrink-0 ${job.status === 'applied' ? 'bg-[color:var(--primary)]/10 text-[color:var(--primary)]' :
