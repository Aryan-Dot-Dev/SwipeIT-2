...
export default function LoginPage() {
  ...
  useEffect(() => {
    // If user has a valid session cookie, skip login and go straight to dashboard
      ...
      <header className="w-full py-6 sm:py-8">
        <div className="max-w-md md:max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <a href="/" className="flex items-center gap-3">
            <img src="/logo_bg_removed_new.png" alt="SwipeIt" className="h-12 sm:h-14 object-contain" />
