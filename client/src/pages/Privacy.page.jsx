  ...
  const sections = [
    {
      ...
      content: (
        <>
          <p>We collect information you provide directly to us, such as when you create an account, update your profile, or communicate with other users. This includes:</p>
          <ul className="list-disc pl-6 mt-2 space-y-1">
            <li>Personal information (name, email, phone number)</li>
            <li>Professional information (skills, experience, resume)</li>
    ...
    },
    {
      ...
      content: (
        <>
          <p>We take your privacy seriously and only share information in limited circumstances:</p>
          <ul className="list-disc pl-6 mt-2 space-y-1">
            <li>With your consent (e.g., sharing profile with potential employers)</li>
            <li>To comply with legal obligations</li>
            <li>To protect our rights and prevent fraud</li>
            <li>With service providers who help us operate our platform</li>
          </ul>
          <p className="mt-3 font-medium">We never sell your personal information to third parties for marketing purposes.</p>
        </>
      )
    },
    {
      ...
      <main className="flex-1">
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-6 py-12 md:py-16">
          <div className="text-center">
            <div className="inline-flex items-center gap-2 md:gap-3 px-3 py-1 rounded-full bg-[color:var(--card)] text-green-600 text-xs md:text-sm font-medium">Privacy Policy</div>
            <h1 className="mt-4 md:mt-6 text-2xl md:text-4xl lg:text-5xl leading-tight font-extrabold" style={{ color: 'var(--foreground)' }}>Your Privacy Matters</h1>
            <p className="mt-3 md:mt-4 text-base md:text-lg text-[color:var(--muted-foreground)] max-w-3xl mx-auto px-4">We are committed to protecting your personal information and being transparent about how we collect, use, and safeguard your data.</p>
          </div>
        </section>

        <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-6 py-8 md:py-12">
          <div className="space-y-4 md:space-y-6">
            {sections.map((section, i) => <PrivacySection key={i} {...section} />)}
          </div>
        </section>

        <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-6 py-8 md:py-12">
          <div className="p-4 md:p-6 bg-[color:var(--card)] rounded-xl text-center">
            <h2 className="text-lg md:text-xl font-semibold mb-3 md:mb-4">Questions About Your Privacy?</h2>
            <p className="text-sm md:text-base text-[color:var(--muted-foreground)] mb-4 md:mb-6">If you have any questions about this Privacy Policy or our data practices, please don't hesitate to contact us.</p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-6">
            <div className="bg-gradient-to-r from-[color:var(--primary)] to-[color:var(--secondary)] rounded-xl p-6 md:p-8 text-white flex flex-col md:flex-row items-center justify-between gap-4 md:gap-0">
              <div className="text-center md:text-left">
                <div className="text-lg md:text-xl font-semibold">Last updated: August 2025</div>
                <div className="mt-1 md:mt-2 text-sm md:text-base">We regularly review and update our privacy practices to ensure they meet the highest standards.</div>
              </div>
              <div className="flex-shrink-0">
                <a href="/contact"><Button className="text-white bg-white/10 hover:bg-white/20 border border-white/20" style={{ background: 'transparent' }}>Contact Data Protection Officer</Button></a>
              </div>
            </div>
          </div>
        </section>
